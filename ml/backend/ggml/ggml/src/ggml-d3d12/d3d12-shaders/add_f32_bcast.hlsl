// Broadcasting F32 elementwise add.
// src0 is same-shape as dst (contiguous); src1 broadcasts per ggml_can_repeat
// (each src1 dim divides the corresponding src0 dim).
